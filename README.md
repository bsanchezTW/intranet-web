...
| **integer IDENTITY** (1, 2, 3…) | `news_articles`, `events`, `applications`, `courses`, `vacation_periods`, `vacation_balance_adjustments`, `lunch_menu`, `public_holidays`, `documents`, `other_documents`, `study_materials`, `event_photos`, `linkedin_posts`, `user_course_progress`, `cost_centers` |
| **bigint IDENTITY** (1, 2, 3…) | `questions`, `question_options`, `change_log`, `ticket_replies`, `expense_request_items`, `expense_request_attachments` |
