...
| **integer IDENTITY** (1, 2, 3…) | `news_articles`, `events`, `applications`, `courses`, `vacation_periods`, `claude_conversations`, `vacation_balance_adjustments`, `lunch_menu`, `public_holidays`, `documents`, `other_documents`, `study_materials`, `event_photos`, `linkedin_posts`, `user_course_progress` |
