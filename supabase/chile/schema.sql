...
CREATE INDEX IF NOT EXISTS idx_applications_catalog ON chile.applications (catalog);
CREATE INDEX IF NOT EXISTS idx_applications_catalog_orden ON chile.applications (catalog, sort_order);
